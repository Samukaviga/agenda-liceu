...
<head>
    ...
    <meta name="author" content="Traço Marcenaria">
    <title>Traço Marcenaria</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            <img src="app-assets/images/logo/logo-traco.png">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Bem-vindo ao Sistema da Traço! 👋</h2>
                                <p class="card-text mb-2">Faça login na sua conta e comece o trabalho</p>
                                <form class="form-signin" method="post" action="web_services/functions/validacao.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">Senha</label><a href="#"><small>Esqueceu a senha?</small></a>
                                        </div>
