...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>Liceu Brasil - Bolsas</title>
    <!-- Favicon-->
  ...
  <body>
      ...
      <div class="main-content py-5">
        <div class="container">
          <div class="row justify-content-between align-items-center">
            <div class="col-12 col-md-5 mb-5 mb-md-0"><img src="img/bg-img/thank-you.png" alt=""></div>
            <div class="col-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/ML9hHM_4F0c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              
              <a class="btn btn-primary btn-lg" href="https://whatsapp.liceudabeleza.com.br/bolsas">ENTRAR NO GRUPO</a>
    ...
    <!--script src="adm/assets/js/agendamentos-data.js"></script-->
  </body>
</html>